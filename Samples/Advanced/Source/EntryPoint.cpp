...
int main(int argc, char **argv)
{
    ...
    RenderMeshBuffer *pRenderVertexBuffer = pRenderObject->CreateVertexBuffer<RenderMeshBuffer>();
    ...
    RenderMeshBuffer *pRenderIndexBuffer = pRenderObject->CreateIndexBuffer<RenderMeshBuffer>();
